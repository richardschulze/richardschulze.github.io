...
1.  A. Rasch, R. Schulze, D. Shabalin, A. Elster, S. Gorlatch, M. Hall \\
    ...
    *ACM SIGPLAN International Conference on Compiler Construction (CC 2023)*\\
    <a href="../assets/files/paper/cc23/paper.pdf"><i class="fas fa-file-pdf" style="color: red; font-size: 2em; padding-top: .4em"></i></a> [Paper](../assets/files/paper/cc23/paper.pdf)
...
1.  A. Rasch, R. Schulze, and S. Gorlatch \\
    ...
    *International Conference on Parallel Architectures and Compilation Techniques (PACT 2019)*\\
    <a href="../assets/files/paper/pact19/paper.pdf"><i class="fas fa-file-pdf" style="color: red; font-size: 2em; padding-top: .4em"></i></a> [Paper](../assets/files/paper/pact19/paper.pdf)
...
1.  A. Rasch, R. Schulze, M. Gorus, J. Hiller, S. Bartholomäus, S. Gorlatch \\
    ...
    *ACM/SIGAPP Symposium On Applied Computing (SAC 2018)*\\
    <a href="../assets/files/paper/sac18/paper.pdf"><i class="fas fa-file-pdf" style="color: red; font-size: 2em; padding-top: .4em"></i></a> [Paper](../assets/files/paper/sac18/paper.pdf)


2.  A. Rasch, M. Wrodarczyk, R. Schulze, S. Gorlatch \\
...
1.  A. Rasch, R. Schulze, S. Gorlatch. \\
    ...
    *Hierarchical Parallelism for Exascale Computing (HiPar@SC 2022), (WIP paper)*\\
    <a href="../assets/files/paper/wip_short/sc22/paper.pdf"><i class="fas fa-file-pdf" style="color: red; font-size: 2em; padding-top: .4em"></i></a> [Paper](../assets/files/paper/wip_short/sc22/paper.pdf)
...
2.  R. Schulze, A. Rasch, S. Gorlatch \\
    ...
    *International Conference for High Performance Computing, Networking, Storage and Analysis (SC 2021), (short paper)*\\
    <a href="../assets/files/paper/wip_short/sc21/paper.pdf"><i class="fas fa-file-pdf" style="color: red; font-size: 2em; padding-top: .4em"></i></a> [Paper](../assets/files/paper/wip_short/sc21/paper.pdf)
...
1.  A. Rasch, R. Schulze, S. Gorlatch \\
    ...
    *International Workshop on Polyhedral Compilation Techniques (IMPACT 2020), (WIP paper)*\\
    <a href="../assets/files/paper/wip_short/impact20/paper.pdf"><i class="fas fa-file-pdf" style="color: red; font-size: 2em; padding-top: .4em"></i></a> [Paper](../assets/files/paper/wip_short/impact20/paper.pdf)
...
2.  A. Rasch, R. Schulze, S. Gorlatch \\
    ...
    *International Workshop on OpenCL (IWOCL 2019), (extended abstract)*\\
    <a href="../assets/files/paper/wip_short/iwocl19/paper.pdf"><i class="fas fa-file-pdf" style="color: red; font-size: 2em; padding-top: .4em"></i></a> [Paper](../assets/files/paper/wip_short/iwocl19/paper.pdf)
...
3.  A. Rasch, R. Schulze, S. Gorlatch\\
    ...
    *Proceedings of the International Conference for High Performance Computing, Networking, Storage and Analysis (SC) (2018), (short paper)*\\
    <a href="../assets/files/paper/wip_short/sc18/paper.pdf"><i class="fas fa-file-pdf" style="color: red; font-size: 2em; padding-top: .4em"></i></a> [Paper](../assets/files/paper/wip_short/sc18/paper.pdf)
